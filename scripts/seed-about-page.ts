...
const ABOUT_DATA: Record<string, {
  ...
  en: {
    ...
    teamMembers: [
      ...
      { name: "Abu Ra'sha", role: "Human Resources Manager", bio: "Human Resources Manager at ESAP AI, dedicated to building and supporting the talented team that drives ESAP's innovation and growth.", image: "/team/Abu Ra'sha.jpg" }
    ]
  },
  ar: {
    ...
    teamMembers: [
      ...
      { name: "أبو رشا", role: "مدير الموارد البشرية", bio: "مدير الموارد البشرية في إساب للذكاء الاصطناعي، مكرس لبناء ودعم الفريق الموهوب الذي يدفع ابتكار ونمو إساب.", image: "/team/Abu Ra'sha.jpg" }
    ]
  },
};
