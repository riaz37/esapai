  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all duration-500 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-primary/50 group/btn",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-[#020305]/40 backdrop-blur-md border border-white/10 text-primary shadow-[0px_4px_54px_11px_rgba(226,226,226,0.15)_inset] hover:shadow-[0px_4px_54px_11px_rgba(226,226,226,0.25)_inset] hover:bg-white/10 hover:border-white/20 hover:scale-105 active:scale-95",
        outline:
          "bg-transparent border border-white/20 text-white hover:border-primary hover:text-primary hover:bg-primary/10 hover:shadow-[0_0_20px_rgba(19,245,132,0.15)] hover:-translate-y-0.5 active:scale-[0.98] relative overflow-hidden",
        ghost:
