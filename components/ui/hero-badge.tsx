    ...
    ({ className, pillText = "Exclusive", description = "Tomorrow's Edge, Built Today", ...props }, ref) => {
        return (
            ...
            >
                ...
                {/* Left: Exclusive Pill */}
                <div className="relative z-10 flex items-center justify-center px-5 py-2 sm:px-6 sm:py-2.5 rounded-full bg-[#13F584] shadow-[0_0_15px_rgba(19,245,132,0.4)]">
                    <span className="text-[11px] sm:text-sm font-bold uppercase tracking-wider text-black leading-none">
                        {pillText}
                    </span>
                </div>

                {/* Right: Text */}
                <div className="relative z-10 flex items-center px-4 py-2 sm:px-5 sm:py-2.5 ml-1">
                    <span className="text-[12px] sm:text-base font-medium tracking-wide text-[#13F584] leading-none">
                        {description}
                    </span>
                </div>
            </div>
